...
@Singleton
@Component(modules = [AppModule::class, NetworkModule::class, CountriesModule::class, ViewModelFactoryModule::class, ViewModelModule::class, MainActivityModule::class])
